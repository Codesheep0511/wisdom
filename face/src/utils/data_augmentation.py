...
from src.utils.preprocessor import _imread as imread
from src.utils.preprocessor import _imresize as imresize
from src.utils.preprocessor import to_categorical
import scipy.ndimage as ndi
import cv2


class ImageGenerator(object):
    """ 具有饱和度、亮度、照明、对比度的图像生成器。
    水平翻转和垂直翻转的转换。它支持
    界定框坐标。
    TODO:
        - 完成对不使用包围盒的支持
